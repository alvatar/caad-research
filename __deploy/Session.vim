...
badd +136 /data/projects/ensanche-core/analysis.scm
badd +222 /data/projects/ensanche-core/geometry.scm
badd +93 /data/projects/ensanche-core/math.scm
badd +1 /data/projects/ensanche-core/validators.scm
badd +37 /data/projects/ensanche-core/utils/misc.scm
badd +7 /data/projects/ensanche-core/strategies/predesigned-band.scm
silent! argdel *
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 222 - ((0 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
222
